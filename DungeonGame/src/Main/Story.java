...
public class Story {
    ...
    public static void deathScreen(){
        ...
        System.out.println("On the bright side, at least you won't have to deal with those monsters anymore.");
    ...
    public static void winScreen(){
        ...
        GameLogic.printSeperator(30);
        GameLogic.printSeperator(30);
        System.out.println("And just like that, you emerge on the other side. Very scathed, but alive none-the-less");
        ...
        System.out.println("So, you step towards the setting sun on the horizon, but you'll never forget the " +
                "adventure that brought you here. Or maybe you will. We don't judge.");
